defmodule ChavezWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("chavez.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("chavez.repo.query.idle_time", unit: {:native, :millisecond}),
